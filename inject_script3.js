        ...
        <div id="custom-portal-dialog" role="dialog" class="pointer-events-auto w-full max-w-lg border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg" data-state="closed" style="background:#020817; color:#f8fafc; border-color:#1e293b;">
            ...
            <div class="flex flex-col gap-4 py-4">
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Campus</label>
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Program</label>
            ...
            <div class="text-xs text-muted-foreground bg-white/5 p-3 rounded-md" style="color:#94a3b8; background-color:rgba(255,255,255,0.05); text-align:left;">
...
<footer class="italic text-xs text-center text-muted-foreground pb-4" style="color:#94a3b8; padding-bottom:1rem; padding-top:2rem;">
    This website is for school purposes only. The original website is <a href="https://neust-portal.link/" style="color:#f97316; text-decoration:underline;">https://neust-portal.link/</a>.
</footer>
...
campusSelect.addEventListener('change', (e) => {
    ...
    if(val) {
        ...
        programSelect.innerHTML = '<option value="">Select Program...</option>' + programsList.map(p => \\\<option value="\\\">\\\</option>\\\).join('');
    } else {
...
function closeModal() {
    // Trigger outline animation
    modalOverlay.setAttribute('data-state', 'closed');
    modalDialog.setAttribute('data-state', 'closed');
    
    // Wait for the duration-200 animation to end before display none
    setTimeout(() => {
